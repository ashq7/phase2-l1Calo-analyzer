...
//=========  (Tue Jun 11 10:30:18 2024) by ROOT version 6.30/03
   ...
   entry=leg->AddEntry(grae1,"#scale[0.6]{#scale[1.2]{Standalone e/ #gamma w/o WP}}","lepz");
   ...
   entry->SetMarkerSize(2);
   entry->SetTextFont(42);
   entry=leg->AddEntry(grae2,"#scale[0.6]{#scale[1.2]{Standalone e/ #gamma with WP}}","lepz");
