...
void makeEfficienciesPlotForOneScheme(TString mode, bool useOwnIsolationFlag, bool useOwnShowerShapeFlag, float acceptancePerBin, int nBinToStartFit, float isoPlateauPt)
{
  ...
  TString rootFileDirectory2 = "/afs/hep.wisc.edu/home/aquinn8/DoublePhoton_combined_11Jun.root";
  TString outputDirectory = "/afs/hep.wisc.edu/home/aquinn8/CMSSW_14_0_0_pre3/src/figures/efficiencyPlots/Jun11/";
  ...
  plotNEfficiencies(vGraphs, vLabels, vColors, vStyles,
                    ...
                    outputDirectory, "p_{T}^{e/#gamma} > 25 GeV, |#eta^{GEN #gamma}| < 1.5", 0.0, 1.02, "");  
